...
if not os.path.exists("CUDA_Compute_Compatibility-CUDA SDK support vs Microarchitechture.csv"):
    with open("CUDA_Compute_Compatibility-CUDA SDK support vs Microarchitechture.csv",'w') as compat_csv:
